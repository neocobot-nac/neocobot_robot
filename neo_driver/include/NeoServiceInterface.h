#ifndef _NEOSERVICEINTERFACE_H
#define _NEOSERVICEINTERFACE_H
...
typedef NEOCStatus(*RobotGetStateType)(RobotState*);
...
public:
    ...
    RobotGetStateType           RobotGetStateFunc;
...
public:
    ...
    bool load()
    {
        ...
        RobotGetStateFunc = (RobotGetStateType)dlsym(NeoSI, "SI_RobotGetState");
        if(RobotGetStateFunc == NULL)
        {
            return false;
        }
