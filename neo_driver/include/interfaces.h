...
typedef NEOStatus(*AddEndEffectorType)(const char*, Pose, const double, const double*);
typedef NEOStatus(*DeleteEndEffectorType)(const char*);
typedef NEOStatus(*LoadEndEffectorType)(const char*);
typedef NEOStatus(*EmitEESignalType)(unsigned int);
typedef NEOStatus(*UnloadEndEffectorType)();
typedef NEOStatus(*SaveEEParametersType)(const char*, Pose, const double, const double*);
typedef NEOStatus(*GetEEParametersType)(const char*, Pose*, double*, double*);
...
public:
    ...
    **********************************************************************************************************************/
    ...
    Input arguments:
    	...
    	@param: Pose          pose    动力学参数
    	@param: const double  mass    质量
    	@param: const double* CoM     质心
    Output arguments:
    	@value: NEOStatus
    **********************************************************************************************************************/
    NEOStatus AddEndEffector(const char* name, Pose pose, const double mass, const double* CoM);
    ...
    Output arguments:
    	@value: NEOStatus
    **********************************************************************************************************************/
    NEOStatus DeleteEndEffector(const char* name);
    ...
    **********************************************************************************************************************/
    ...
    Output arguments:
    	@value: NEOStatus
    **********************************************************************************************************************/
    NEOStatus SaveEEParameters(const char* name, Pose pose, const double mass, const double* CoM);
    ...
    Input arguments:
    	@param: const char*   name    末端工具名称
    	@param: Pose*         pose    动力学参数
    	@param: double*       mass    质量
    	@param: double*       CoM     质心
    Output arguments:
    	@value: NEOStatus
    **********************************************************************************************************************/
    NEOStatus GetEEParameters(const char* name, Pose* pose, double* mass, double* CoM);
